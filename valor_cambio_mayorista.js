...
const URL_BCRA_CAMBIO_MAYORISTA = 'http://www.bcra.gov.ar/PublicacionesEstadisticas/Principales_variables_datos.asp?serie=272&detalle=Tipo%20de%20Cambio%20Mayorista%20(%24%20por%20US%24)%20Comunicaci%F3n%20A%203500%A0-%20Referencia'
    ...
    return new Promise(async function(resolve, reject) {
        try {
            ...
            for (positionInColumns = 0; positionInColumns < lenghtColumnsInTable; positionInColumns++) {
                ...
                fs.appendFileSync('valor_cambio_mayorista-'+processParams.fechaDesde+'hasta'+processParams.fechaHasta+'.json',putJSONData)
...
const preparePage = async () => {
    ...
    await page.goto(URL_BCRA_CAMBIO_MAYORISTA, {
